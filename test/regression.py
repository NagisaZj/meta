    ...
    def ttrain(self):
        ...
        for it in range(self.num_iterations):
            for i in range(1):
                ...
                out = self.base_net.forward_ori(sample_x)
            ...
            if (it+1) %100==0:
                print('Update', it,'train_loss:',loss.data.cpu().numpy())
        plt.figure()
...
if __name__=='__main__':
    ...
    #print(x)
    net = Base_net(None)
    t = trainer(num_samples=100,num_tasks=2,num_updates=10, step_size=1e-2,meta_step_size=1e-2,
