...
if __name__=="__main__":
    ...
    parser.add_argument('--num_tasks_train', help='the number of meta-training set', type=int, default=10)
    ...
    parser.add_argument('--batch_size', help='batch size(also episode length)', type=int, default=10)
    ...
    log_dir = args.dir + str(args.inner_lr) + '_' + str(
        ...
        args.batch_size) + '_' + str(args.variance) + 'balance/'
